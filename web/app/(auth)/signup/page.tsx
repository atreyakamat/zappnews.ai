...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // For now, auto-approve signups (will improve for production)
    localStorage.setItem('zappnews_auth', 'true');
    localStorage.setItem('zappnews_user', JSON.stringify({ email, name }));
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in-up">
          ...
          <p className="text-gray-400">Start getting AI news delivered fresh</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input 
                type="checkbox" 
                required
                className="w-4 h-4 mt-1 rounded border-gray-600 bg-gray-700 text-purple-500" 
              />
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#0f0f1a] text-gray-500">or continue with</span>
              </div>
            </div>
